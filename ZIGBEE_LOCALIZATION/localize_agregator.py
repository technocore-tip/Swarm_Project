...
message ="ref-node1: 1_0.132275791 2_0.088932425"
...
message ="ref-node2: 1_0.134349434 2_132102382"
if message.find("ref-node1:",0,10) !=-1: #spit the transmitted message from reference node
    RSSI_strings[0]= message.split(" ",-1)
    del RSSI_strings[0][0]
if message.find("ref-node2:",0,10) !=-1:
...
message ="ref-node3: 1_0.12700944 2_0.224631531"
...
message ="ref-node4: 1_0.132906608 2_0.117699689"
