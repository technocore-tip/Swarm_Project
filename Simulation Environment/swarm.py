...
def distance_vector(P1,P2):#function to calculate distance between two points
	x = P1.getX()-P2.getX()
	y = P1.getY()-P2.getY()
	return x,y
	pass
...
def relative_distance(robot,robots):#calculate relative distance of a robot to all other robots
	x_total=0
	y_total=0
	for r in robots:
...
def main():
	...
	robots = draw_swarm(10,win) #draw 7 swarm in win
